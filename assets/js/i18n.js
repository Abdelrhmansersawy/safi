...
export const I18N = {
  ar: {
    ...
    skin:{modern:"حديث", asil:"أصيل"}, skin_to:s => "التصميم: " + s,
    ...
    s4:"الأرصدة", s4_hint:"الأزرق = ليه فلوس. الأحمر = عليه فلوس.",
  ...
  en: {
    ...
    skin:{modern:"Modern", asil:"Classic"}, skin_to:s => "Design: " + s,
    ...
    s4:"Balances", s4_hint:"Blue = they're owed. Red = they owe.",
